...
class MusicBot(discord.Client):
    ...
    async def on_ready(self):
        ...
        print("  Auto-Join: " + ['Disabled', 'Enabled'][self.config.auto_join])
        ...
        elif self.config.auto_join:
            print("Attempting to autosummon...", flush=True)

            # waitfor + get value
            owner_vc = await self._auto_join()
    ...
    async def cmd_join(self, channel, author, voice_channel):
        """
        Usage:
    ...
    async def cmd_setavatar(self, message, url=None):
        ...
        return Response("No", delete_after=20)


    async def cmd_leave(self, server):
        await self.disconnect_voice_client(server)
        return Response("Ayy lmao", delete_after=20)
